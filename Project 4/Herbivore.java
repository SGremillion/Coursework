/**
* This is the Herbivore abstract class that implements Dinosaur interface
*     and Comparable<T> interface. H_Ornithiscian and H_Sauropod extend 
*     this class.
* 
* This class:
* ...contains the all of the shared instance variables for all of
*     the Herbivores: diet, time, location, size, legs, teeth, weight, food.
* ...has a constructor that initializees all of the above instance 
*     variables, also setting diet to the appropriate "Herbivores".
...
abstract class Herbivore implements Dinosaur, Comparable<Herbivore> {
   // variables
   private String diet;
   private String time;
   ...
   // constructor
   public Herbivore(String tim, String locate, double siz, int leg, String teet, int weigh, String foo) {
      diet = "Herbivore";
      time = tim;
      location = locate;
      size = siz; 
   ...
   public int compareTo(Herbivore dino) {
