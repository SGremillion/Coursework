/**
* This is the CT_Velociraptor concrete class that extends C_Theropod
...
*     this dinosaur
* ...has printVelo() method that prints ASCII art of this dino.
* 
...
public class CT_Velociraptor extends C_Theropod {
   // constructor
   public CT_Velociraptor(String tim, String locate, double siz, int leg, String teet, int weigh, String foo) {
      super(tim, locate, siz, leg, teet, weigh, foo);
   }
   
   // getters
   public String getName() { return "Velociraptor"; }
   public String getMeaning() { return "quick plunderer"; }
   public String getPerson() { return "Osborn (1924)"; }
   ...
   // method to print velociraptor picture
